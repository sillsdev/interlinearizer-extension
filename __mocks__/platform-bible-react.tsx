 ...
 *
 * @param props - Component props.
 * @param props.children - Trigger or anchor, and (while open) content elements.
 * @param props.onOpenChange - Called by the trigger with the toggled open state.
 * @param props.open - Whether the popover is currently open.
 * @returns The children wrapped in open-state context.
 */
