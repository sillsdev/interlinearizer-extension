...
export default function ProjectModals({
   ...
   * regardless of whether persistence succeeds. This is safe: when dirty is `false` the draft is
   * either already committed to the active project or empty (nothing to lose); when dirty is `true`
   * the {@link DiscardDraftConfirm} dialog has already obtained consent to discard.
   *
