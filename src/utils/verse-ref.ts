 ...
 *
 * A heading contains every verse named by the verse marker it falls within, and follows that
 * verse's text in document order unless it precedes all of it, as a chapter's opening heading
 * precedes verse 0.
 */
