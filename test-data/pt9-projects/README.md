...
Minimal Paratext 9 projects for exercising the Paratext 9 interlinear import against a real
...
verse, runs of words a phrase can span, forms that divide into a stem and a suffix, forms that recur
with no cluster of their own, so an analysis approved elsewhere has somewhere to be suggested, one
form approved four times over, so its pool bucket holds competing payloads, and headings, one of
them splitting a verse.

Cluster `Range` values are character offsets into the verse text (in `PIE`, into PT9's own verse
string, markers and headings included), so changing a verse means recomputing every range at or
after the change, in every gloss language for that book.
...
| ------- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PIA`   | Happy path    | Two gloss languages (`es`, `fr`) over one book, so records merge across languages and one token's parses conflict; five phrase clusters in `es` (a plain two-word one, one ambiguous between two matching runs, one overlapping an approved run so it demotes to `candidate`, an excluded one, and a three-word one both languages gloss); word parses, including a one-morpheme one on a token the other language leaves alone; a word and a parse cluster sharing one range; verse hashes placed so each analysis shape has at least one approved instance; a verse no language approves, whose glosses import as suggestions - one on a form nothing else analyzes, so accepting it gives that form's unanalyzed occurrences a suggestion, and one on a form the pool already glosses differently, so the imported gloss ranks ahead of the pool's; one verse approved by `es` alone, so the phrase both languages gloss merges back down to `suggested`; an excluded cluster; a punctuation entry; a repeated surface form, for an ambiguous anchor; two unanalyzed tokens whose forms carry an approved analysis elsewhere in the book, for the suggestion pool; one form (`plovs`) approved four times across two verses, once sentence-initially so only case folding files it under the same pool key, giving that key four competing payloads - two alike in gloss and morpheme breakdown, one with that gloss and no breakdown, one with that breakdown under a different gloss; every sense-resolution outcome; every bare-word-analysis outcome |
| `PIB`   | Cluster drops | Every `clusterDrops` reason (`formMismatch`, `duplicateCluster`, `lemmaOrOther`, `unparseableLexemeId`, `verseNotFound`, and `frontMatter` from a gloss on the book's title); two phrases that drop, one matching no run of words and one whose form is blank, beside a phrase that anchors as a control, in an approved verse so it lands somewhere visible; plus an `Interlinear_es_JAS.xml` for a book the project has no text for, which reports `bookFound: false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `PIE`   | Headings      | Headings glossed where PT9 files them, with the verse before each: one opening the chapter, under verse 0 beside the front matter; a section heading and a parallel-reference line after a verse; one splitting a verse, whose resumed text keeps that verse's glosses; and a form repeated in the verse ahead of the headings, whose lone gloss must still land on its later occurrence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
