...
| ------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PIA`   | Happy path    | Two gloss languages (`es`, `fr`) over one book, so records merge across languages and one token's parses conflict; four phrase clusters (a plain two-word one, one ambiguous between two matching runs, an excluded one, and a three-word one both languages gloss); word parses; a word and a parse cluster sharing one range; an approved verse hash; an excluded cluster; a punctuation entry; a repeated surface form, for an ambiguous anchor; every sense-resolution outcome; every bare-word-analysis outcome |
